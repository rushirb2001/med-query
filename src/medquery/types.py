"""Shared type definitions for MedQuery.
...
These types are used across the generators, eval, and backend modules.
"""

from typing import Literal

# =============================================================================
# TYPE LITERALS (for Pydantic/typing)
# =============================================================================
...
RetrievalStrategy = Literal["vector_search", "graph_traversal", "hybrid_search", "metadata_lookup", "graph_then_vector"]
